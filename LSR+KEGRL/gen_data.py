...
parser.add_argument('--in_path', type = str, default =  "../dataset/DocRED")
parser.add_argument('--out_path', type = str, default = "prepro_glove", choices=["prepro_glove", "prepro_re_glove"])
