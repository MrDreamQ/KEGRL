...
parser.add_argument('--grad_accu_step', type=float, default=1, help='Gradient Accumulation step.')
...
# Knowledge Embedding Graph Module 
parser.add_argument('--sgraph', type=int, default=0)
parser.add_argument('--dgraph', type=int, default=0)
parser.add_argument('--ada_lamb', type=float, default=0.05)
parser.add_argument('--dataset', type=str, default='docred', choices=['docred', 're', 'dwie'])
...
# args.seed = random.randint(0, 1e4)
args.seed = 0
