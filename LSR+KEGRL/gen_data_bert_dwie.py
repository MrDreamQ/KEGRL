...
parser.add_argument('--out_path', type = str, default = "prepro_dwie_bert")
...
bert_config = BertConfig(max_position_embeddings=1800)
bert = Bert(BertModel(config=bert_config), 'bert-base-uncased', 'dwie')
